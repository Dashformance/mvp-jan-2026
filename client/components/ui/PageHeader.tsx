        ...
        <GlassCard className="mb-6 px-6 py-4 flex items-center justify-between gap-6 bg-zinc-900/60 backdrop-blur-xl border-white/5 shadow-2xl">
            ...
            <div className="flex items-center gap-4">
                <div className="relative shrink-0">
                    ...
                    <div className="relative h-12 w-12 rounded-xl bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center text-black font-bold text-xl shadow-lg border border-emerald-300/20 font-numbers">
                        {levelInfo.level}
                    </div>
                ...
                <div className="flex flex-col gap-0.5">
                    <span className="text-emerald-400 font-medium text-sm tracking-wide">Imortal</span>
            ...
            <div className="w-48 flex flex-col gap-1.5">
                ...
                <div className="h-2 w-full bg-zinc-800/80 rounded-full overflow-hidden border border-white/5">
                    <div
                        className="h-full bg-gradient-to-r from-emerald-600 to-emerald-400 shadow-[0_0_10px_rgba(16,185,129,0.4)] transition-all duration-1000 ease-out"
